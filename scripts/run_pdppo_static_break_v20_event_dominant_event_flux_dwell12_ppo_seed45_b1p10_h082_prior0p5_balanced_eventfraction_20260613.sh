...
OUT_DIR=reports/v31_static_break_v20_event_dominant_event_flux_dwell12_ppo_seed45_b1p10_h082_prior0p5_balanced_eventfraction_20260613
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 45 \
  --out-name v20_eventdom_eventflux_b1p10_seed45_h082_prior0p5_balanced_eventfraction_summary.csv
