...
def main() -> None:
    ...
    out = build_scheduler_dataset(truth_csv=args.truth_csv, env_cfg_path=args.env_cfg, sensor_cfg_path=args.sensor_cfg, estimator_cfg_path=args.estimator_cfg, scheduler_cfg_path=args.scheduler_cfg, run_id=args.run_id, out_npz=out_npz, checkpoint=args.checkpoint, split_name=args.split)
    print(out['out_npz'])
