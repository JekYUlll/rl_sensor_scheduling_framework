...
cd "$ROOT"
out="reports/analysis/v473r1_activity_aligned_demand_geometry_b1p58_20260903"
log="logs/v473r1_activity_aligned_demand_geometry_b1p58_20260903.log"
status="logs/v473r1_activity_aligned_demand_geometry_b1p58_20260903.exit"
runs=(
