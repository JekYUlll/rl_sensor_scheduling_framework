...
# This scene has zero degradation coverage.  Keep the inert quality tail out of
# the state so the final three state dimensions are exactly the nowcast inputs.
