...
OUT_DIR=reports/v31_static_break_v16_micro_particle_dwell12_ppo_seed42_h075_soc_20260609
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 42 \
  --out-name v16_micro_particle_b1p15_seed42_dwell12_ppo_h075_soc_summary.csv
