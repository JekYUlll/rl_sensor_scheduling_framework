...
RUN_PREFIX=v268_relative_block_gain_pdppo_sixch_dev \
LOG_PREFIX=v268_relative_block_gain_pdppo_sixch \
bash scripts/run_v267_block_gain_pdppo_sixch_dev_20260830.sh 5801 5802
