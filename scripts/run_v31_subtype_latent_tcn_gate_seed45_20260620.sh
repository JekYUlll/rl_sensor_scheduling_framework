...
"$PY" scripts/58_v31_split_protocol_run.py \
  --out-dir reports/v31_subtype_latent_tcn_gate_seed45_h082_20260620 \
  ...
  --flux-wind-exponent 4.3 \
  --event-microstructure-sigma 0.40 \
  --event-microstructure-alpha 0.20 \
  --event-microstructure-diameter-scale 0.05 \
  --event-microstructure-velocity-scale 0.6 \
  --event-particle-microstructure-correlation 0.0 \
  --event-subtypes-enabled \
  --event-subtype-particle-prob 0.30 \
  --event-subtype-flux-prob 0.42 \
  --event-subtype-thermal-prob 0.28 \
  --event-subtype-particle-flux-multiplier 0.10 \
  --event-subtype-flux-multiplier 8.0 \
  --event-subtype-thermal-flux-multiplier 0.10 \
  --event-subtype-particle-diameter-shift-mm 0.12 \
  --event-subtype-particle-velocity-boost-ms 1.4 \
  --event-subtype-flux-diameter-shift-mm 0.00 \
  --event-subtype-flux-velocity-boost-ms 0.00 \
  --event-subtype-thermal-surface-drop-c 4.0 \
  --event-subtype-particle-humidity-boost-pct 24.0 \
  --event-subtype-flux-wind-boost-ms 0.6 \
  --event-subtype-thermal-air-temp-drop-c 1.5 \
  --event-subtype-latent-alpha 0.12 \
  --event-subtype-particle-latent-diameter-scale-mm 0.09 \
  --event-subtype-particle-latent-velocity-scale-ms 2.4 \
  --event-subtype-flux-latent-sigma 1.8 \
  --event-subtype-thermal-latent-surface-scale-c 5.0 \
  ...
  --target-weights 0.03 24.0 0.10 0.01 0.01 0.0 220.0 55.0 55.0 \
