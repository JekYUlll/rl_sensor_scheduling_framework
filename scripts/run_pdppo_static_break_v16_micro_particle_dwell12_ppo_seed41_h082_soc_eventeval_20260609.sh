...
OUT_DIR=reports/v31_static_break_v16_micro_particle_dwell12_ppo_seed41_h082_soc_eventeval_20260609
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 41 \
  --out-name v16_micro_particle_b1p15_seed41_h082_soc_eventeval_summary.csv
