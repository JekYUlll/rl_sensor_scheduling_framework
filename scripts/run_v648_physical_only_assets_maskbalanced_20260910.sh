...
TRUTH_ROOT="${V648_TRUTH_ROOT:-reports/v645_empirical_cold_wind_truth_20260910}"
RESOURCE_ROOT="${V648_RESOURCE_ROOT:-reports/v614_empirical_cold_availability_truth_20260910}"
OUT_ROOT="${V648_ASSET_ROOT:-reports/v648_physical_only_assets_maskbalanced_20260910}"
...
for seed in 7401 7402 7403 7404; do
  ...
  "$PYTHON_BIN" scripts/25_v2_train_custom_ppo.py \
    ...
    --oracle-rollouts-per-policy 4 --oracle-candidate-mask-repeat 1 \
    --candidate-prior-steps 1024 --candidate-prior-rollouts 4 \
