...
"$PY" scripts/58_v31_split_protocol_run.py \
  --out-dir reports/v31_subtype_single_specialist_subtypeloss_tcn_gate_seed45_h082_20260620 \
  ...
  --subtype-particle-target-weights 0.01 0.10 0.05 0.0 0.0 0.0 50.0 600.0 600.0 \
  --subtype-flux-target-weights 0.01 0.05 0.05 0.0 0.0 0.0 1000.0 80.0 80.0 \
  --subtype-thermal-target-weights 0.05 8.0 0.05 0.0 0.0 0.0 40.0 20.0 20.0 \
