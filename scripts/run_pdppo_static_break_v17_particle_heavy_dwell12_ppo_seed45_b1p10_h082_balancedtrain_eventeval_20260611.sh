...
OUT_DIR=reports/v31_static_break_v17_particle_heavy_dwell12_ppo_seed45_b1p10_h082_balancedtrain_eventeval_20260611
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 45 \
  --out-name v17_particle_heavy_b1p10_seed45_h082_balancedtrain_eventeval_summary.csv
