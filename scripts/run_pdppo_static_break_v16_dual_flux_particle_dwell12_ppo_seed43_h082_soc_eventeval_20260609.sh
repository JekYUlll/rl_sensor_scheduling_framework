...
OUT_DIR=reports/v31_static_break_v16_dual_flux_particle_dwell12_ppo_seed43_h082_soc_eventeval_20260609
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 43 \
  --out-name v16_dual_flux_particle_b1p15_seed43_h082_soc_eventeval_summary.csv
