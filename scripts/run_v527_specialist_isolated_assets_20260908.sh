...
TRUTH_ROOT="${V526_TRUTH_ROOT:-reports/v526_specialist_isolated_truth_20260908}"
OUT_ROOT="${V527_OUT_ROOT:-reports/v527_specialist_isolated_assets_20260908}"
...
for seed in 7181 7182 7183 7184; do
  test -s "$OUT_ROOT/seed${seed}_b2p15/v2_tcn_oracle.pt"
  test -s "$OUT_ROOT/seed${seed}_b2p15/validation_static_candidates.csv"
  test ! -e "$OUT_ROOT/seed${seed}_b2p15/custom_ppo.pt"
done
