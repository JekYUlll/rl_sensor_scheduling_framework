...
# V262 assigns semi-Markov credit to genuine decision times after V259's
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v262_semimarkov_dwell_credit_pdppo_sixch_dev"
    ...
    export GAMMA=0.99 GAE_LAMBDA=0.95 DECISION_ONLY_POLICY_UPDATES=0 DECISION_BLOCK_CREDIT=1
    bash scripts/run_v32_flexible_subset_pilot_20260822.sh "$seed"
  ) >"logs/v262_decision_time_pdppo_sixch_seed${seed}.log" 2>&1
}
