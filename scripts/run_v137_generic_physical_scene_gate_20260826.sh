...
scene_env() {
  export SENSOR_CFG TOTAL_TIMESTEPS="${TOTAL_TIMESTEPS_OVERRIDE:-1024}" TRUTH_STEPS=36000 LOOKBACK=20
  ...
  export EVENT_SUBTYPE_ASSIGNMENT="${EVENT_SUBTYPE_ASSIGNMENT_OVERRIDE:-stratified}" EVENT_SUBTYPE_LATENT_ALPHA=0.15
  ...
  export BC_PRETRAIN_STEPS="${BC_PRETRAIN_STEPS_OVERRIDE:-0}"
  export BC_PRETRAIN_EPOCHS="${BC_PRETRAIN_EPOCHS_OVERRIDE:-1}"
  export BC_PRETRAIN_LOSS_COEF="${BC_PRETRAIN_LOSS_COEF_OVERRIDE:-0}"
  export AWBC_COEF=0 SUBTYPE_AUX_COEF=0 SUBTYPE_ACTION_CE_COEF=0
  export SUBTYPE_LOSS_WEIGHTING=0 CONTEXT_FEATURE_DIM="${CONTEXT_FEATURE_DIM_OVERRIDE:-20}" CONTEXT_FUSION_MODE=gated_add
