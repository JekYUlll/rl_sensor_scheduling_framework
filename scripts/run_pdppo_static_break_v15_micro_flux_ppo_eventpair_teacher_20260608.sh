...
OUT_DIR=reports/v31_static_break_v15_micro_flux_ppo_eventpair_teacher_20260608
...
"$PY" scripts/59_v31_split_protocol_grid.py \
  ...
  --awbc-teacher-calm-sensors surface_temp_ir ultrasonic_anemometer_hd shielded_thermo_hygro snow_particle_counter \
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 41 \
  --out-name v15_micro_flux_b1p15_seed41_eventpair_teacher_summary.csv
