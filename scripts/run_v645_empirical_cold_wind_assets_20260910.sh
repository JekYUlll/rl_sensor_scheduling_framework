...
TRUTH_ROOT="${V645_TRUTH_ROOT:-reports/v645_empirical_cold_wind_truth_20260910}"
RESOURCE_ROOT="${V645_RESOURCE_ROOT:-reports/v614_empirical_cold_availability_truth_20260910}"
OUT_ROOT="${V645_ASSET_ROOT:-reports/v645_empirical_cold_wind_assets_b2p15_20260910}"
...
for seed in 7401 7402 7403 7404; do
  ...
  "$PYTHON_BIN" scripts/25_v2_train_custom_ppo.py \
    ...
    --per-step-budget 2.15 --startup-peak-budget 2.60 --disable-coverage-groups \
