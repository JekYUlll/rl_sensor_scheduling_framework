...
"$PY" scripts/58_v31_split_protocol_run.py \
  --out-dir reports/v31_subtype_reweighted_tcn_gate_seed45_h082_20260620 \
  ...
  --event-microstructure-sigma 1.10 \
  ...
  --event-subtype-particle-flux-multiplier 0.12 \
  --event-subtype-flux-multiplier 8.0 \
  --event-subtype-thermal-flux-multiplier 0.12 \
  --event-subtype-particle-diameter-shift-mm 0.18 \
  --event-subtype-particle-velocity-boost-ms 2.0 \
  --event-subtype-flux-diameter-shift-mm 0.00 \
  --event-subtype-flux-velocity-boost-ms 0.00 \
  --event-subtype-thermal-surface-drop-c 6.0 \
  --event-subtype-particle-humidity-boost-pct 28.0 \
  --event-subtype-flux-wind-boost-ms 1.0 \
  --event-subtype-thermal-air-temp-drop-c 3.0 \
  ...
  --target-weights 0.03 20.0 0.10 0.01 0.01 0.0 180.0 45.0 45.0 \
