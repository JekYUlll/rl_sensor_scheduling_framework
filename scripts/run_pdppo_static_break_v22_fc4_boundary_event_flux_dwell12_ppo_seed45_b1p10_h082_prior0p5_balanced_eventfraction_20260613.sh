...
OUT_DIR=reports/v31_static_break_v22_fc4_boundary_event_flux_dwell12_ppo_seed45_b1p10_h082_prior0p5_balanced_eventfraction_20260613

"$PY" scripts/59_v31_split_protocol_grid.py \
  --out-dir "$OUT_DIR" \
  --sensor-cfg configs/sensors/windblown_sensors_physical_event_v22_fc4_boundary.yaml \
  --budgets 1.10 \
  --seeds 45 \
  --workers 1 \
  --gpu-ids 2 \
  ...
  --ent-coef 0.001 \
  --target-weights 0.03 0.03 0.10 0.01 0.01 0.0 30.0 12.0 12.0 \
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 45 \
  --out-name v22_fc4_eventflux_b1p10_seed45_h082_prior0p5_balanced_eventfraction_summary.csv
