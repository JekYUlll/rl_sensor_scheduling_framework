...
# Bounded follow-up to V249: remove training-time AWBC/BC/oracle guidance and
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v251_no_teacher_pdppo_sixch_dev"
    export TOTAL_TIMESTEPS=200000 TRUTH_STEPS=36000 LOOKBACK=20
