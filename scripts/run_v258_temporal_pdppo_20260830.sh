...
# V258 tests structured temporal encoding as a clean credit-assignment probe.
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v258_temporal_pdppo_sixch_dev"
  ...
  ) >"logs/v258_temporal_pdppo_sixch_seed${seed}.log" 2>&1
}
