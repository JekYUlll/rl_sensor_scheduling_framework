...
def main() -> None:
    ...
    parser.add_argument(
        "--reward-proxy-mode",
        choices=["forecast", "forecast_decision", "forecast_gain", "forecast_block_gain", "forecast_block_relative_gain", "forecast_block_absolute", "aoi", "coverage", "uncertainty", "instant_error"],
        default="forecast",
        help=(
