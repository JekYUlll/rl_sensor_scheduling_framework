...
OUT_DIR=reports/v31_static_break_v18_event_dominant_particle_heavy_dwell12_ppo_seed45_b1p10_h082_prior0p5_eventmid_eventfraction_20260612
...
"$PY" scripts/59_v31_split_protocol_grid.py \
  ...
  --event-gated-actor \
  --event-start-prob 0.75 \
  --event-reward-multiplier 2.0 \
  --soc-aux-horizon 32 \
  --soc-aux-coef 0.03 \
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 45 \
  --out-name v18_eventdom_b1p10_seed45_h082_prior0p5_eventmid_eventfraction_summary.csv
