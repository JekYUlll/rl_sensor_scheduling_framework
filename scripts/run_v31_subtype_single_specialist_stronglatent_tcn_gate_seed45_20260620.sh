...
"$PY" scripts/58_v31_split_protocol_run.py \
  --out-dir reports/v31_subtype_single_specialist_stronglatent_tcn_gate_seed45_h082_20260620 \
  ...
  --event-microstructure-sigma 0.15 \
  ...
  --event-subtype-particle-flux-multiplier 0.03 \
  --event-subtype-flux-multiplier 16.0 \
  --event-subtype-thermal-flux-multiplier 0.03 \
  --event-subtype-particle-diameter-shift-mm 0.20 \
  --event-subtype-particle-velocity-boost-ms 2.8 \
  ...
  --event-subtype-particle-humidity-boost-pct 8.0 \
  --event-subtype-flux-wind-boost-ms 0.2 \
  --event-subtype-thermal-air-temp-drop-c 1.5 \
  --event-subtype-latent-alpha 0.08 \
  --event-subtype-particle-latent-diameter-scale-mm 0.25 \
  --event-subtype-particle-latent-velocity-scale-ms 7.0 \
  ...
  --awbc-teacher-subtype-thermal-sensors surface_temp_ir \
  --prior-kl-coef 0.0 \
  ...
  --target-weights 0.03 4.0 0.10 0.01 0.01 0.0 700.0 280.0 280.0 \
  --target-scales 5.0 5.0 5.0 1.0 1.0 100.0 0.0001 0.2 5.0 \
  --subtype-loss-weighting \
  --subtype-particle-target-weights 0.01 0.05 0.05 0.0 0.0 0.0 20.0 900.0 900.0 \
  --subtype-flux-target-weights 0.01 0.05 0.05 0.0 0.0 0.0 1400.0 40.0 40.0 \
  --subtype-thermal-target-weights 0.05 14.0 0.05 0.0 0.0 0.0 20.0 20.0 20.0 \
