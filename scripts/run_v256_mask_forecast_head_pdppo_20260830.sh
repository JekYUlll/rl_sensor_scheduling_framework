...
# V256 tests a learned candidate-level forecast-cost head.  The head is trained
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v256_mask_forecast_head_pdppo_sixch_dev"
    ...
    export FORECAST_VALUE_AUX_COEF=0.10 FORECAST_VALUE_AUX_STRIDE=64
  ...
  ) >"logs/v256_mask_forecast_head_pdppo_sixch_seed${seed}.log" 2>&1
}
