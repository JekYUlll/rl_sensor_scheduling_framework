...
export OUT_DIR="${OUT_DIR:-reports/v31_static_break_v27_subtype_auto_low_budget_${PROFILE_NAME}_b${BUDGET_TAG}_subtype_aux_ppo_seed45_h082_20260620}"
export SUMMARY_NAME="${SUMMARY_NAME:-v27_subtype_auto_${PROFILE_NAME}_b${BUDGET_TAG}_subtype_aux_ppo_seed45_h082_summary.csv}"
...
export SUBTYPE_AUX_COEF="${SUBTYPE_AUX_COEF:-0.35}"
export SUBTYPE_AUX_CLASSES="${SUBTYPE_AUX_CLASSES:-4}"
export SUBTYPE_AUX_LOOKAHEAD_STEPS="${SUBTYPE_AUX_LOOKAHEAD_STEPS:-0}"
