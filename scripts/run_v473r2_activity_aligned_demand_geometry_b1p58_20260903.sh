...
cd "$ROOT"
out="reports/analysis/v473r2_activity_aligned_demand_geometry_b1p58_20260903"
log="logs/v473r2_activity_aligned_demand_geometry_b1p58_20260903.log"
status="logs/v473r2_activity_aligned_demand_geometry_b1p58_20260903.exit"
runs=(
...
rm -f "$status"
{
  ...
  "$py" scripts/109_v32_audit_subset_forecast_geometry.py \
    ...
    --activity-aligned-transport-demand
  rc=$?
