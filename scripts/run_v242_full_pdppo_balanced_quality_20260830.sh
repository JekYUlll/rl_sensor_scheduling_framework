...
# Full PD-PPO confirmation on the corrected balanced quality scene.  The
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v242_full_pdppo_balanced_quality_dev"
    ...
    export EVENT_SUBTYPE_ASSIGNMENT=stratified_duration
