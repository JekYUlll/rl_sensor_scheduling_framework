...
OUT_DIR=reports/v31_static_break_v16_micro_particle_dwell12_ppo_seed41_h082_laser_teacher_20260609
...
"$PY" scripts/59_v31_split_protocol_grid.py \
  ...
  --eval-rollouts 4 \
  --ent-coef 0.001 \
  --target-weights 0.03 0.03 0.10 0.01 0.01 0.0 12.0 16.0 16.0 \
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 41 \
  --out-name v16_micro_particle_b1p15_seed41_h082_laser_teacher_summary.csv
