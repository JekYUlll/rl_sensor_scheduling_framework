...
OUT_DIR=reports/v31_static_break_v16_particle_heavy_dwell12_ppo_seed45_h082_soc_oraclegreedy_eventeval_20260609
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 45 \
  --out-name v16_particle_heavy_b1p15_seed45_h082_soc_oraclegreedy_eventeval_summary.csv
