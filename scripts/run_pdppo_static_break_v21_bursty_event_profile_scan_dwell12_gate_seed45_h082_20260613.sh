...
OUT_DIR="reports/v31_static_break_v21_bursty_event_profile_scan_dwell12_gate_seed45_h082_20260613"
mkdir -p "$OUT_DIR"
...
python scripts/63_v31_static_break_calibration.py \
  ...
  --event-microstructure-sigma 0.85 \
  --event-microstructure-alpha 0.28 \
  --event-microstructure-diameter-scale 0.22 \
  --event-microstructure-velocity-scale 1.90 \
