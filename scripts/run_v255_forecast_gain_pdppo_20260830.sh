...
# Bounded follow-up to V254: use forecast improvement over a same-epoch
# no-new-measurement counterfactual as the PPO reward.
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v255_forecast_gain_pdppo_sixch_dev"
    ...
    export FORECAST_VALUE_HEAD=0 REWARD_LOSS_NORMALIZATION=none REWARD_PROXY_MODE=forecast_gain
