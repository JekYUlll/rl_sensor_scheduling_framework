...
# V357 is an independently seeded confirmation of V356. The scene, action,
# reward, information, and checkpoint-selection rules are frozen before launch.
ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
cd "$ROOT"
SEEDS=(${SCENE_SEEDS_OVERRIDE:-6901 6902 6903 6904})
POLICY_SEEDS=(${POLICY_SEEDS_OVERRIDE:-7441 7442 7443 7444})
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v357_macro_checkpoint_cycling_pdppo_confirm"
    export LOG_PREFIX="v357_macro_checkpoint_cycling_pdppo_confirm"
  ...
  ) >"logs/v357_macro_checkpoint_cycling_pdppo_confirm_seed${seed}.log" 2>&1
}
