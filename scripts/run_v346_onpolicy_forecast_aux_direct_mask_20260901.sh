...
run_one() {
  ...
  (
    ...
    export CHECKPOINT_SELECTION_INTERVAL_UPDATES=5 CHECKPOINT_SELECTION_MIN_UPDATE=5 CHECKPOINT_SELECTION_SCORE="${CHECKPOINT_SELECTION_SCORE_OVERRIDE:-oracle_loss_mean}" CHECKPOINT_REQUIRE_VALID_BEHAVIOR=1
    ...
    export FORECAST_VALUE_AUX_LOSS="${FORECAST_VALUE_AUX_LOSS_OVERRIDE:-mse}" FORECAST_VALUE_AUX_TEMPERATURE="${FORECAST_VALUE_AUX_TEMPERATURE_OVERRIDE:-1.0}" FORECAST_VALUE_RANKING_COEF=0
    export CANDIDATE_INTERACTION_SCORE=0 DIRECT_MASK_ACTION_SCORE=1 DIRECT_MASK_ACTION_PRIMARY="${DIRECT_MASK_ACTION_PRIMARY:-0}" FACTORIZED_ACTION_POLICY=0
