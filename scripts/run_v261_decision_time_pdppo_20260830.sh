...
# V261 updates PPO actor terms only at genuine decision times after V259's
...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v261_decision_time_pdppo_sixch_dev"
    ...
    export GAMMA=0.99 GAE_LAMBDA=0.95 DECISION_ONLY_POLICY_UPDATES=1
    bash scripts/run_v32_flexible_subset_pilot_20260822.sh "$seed"
  ) >"logs/v261_decision_time_pdppo_sixch_seed${seed}.log" 2>&1
}
