...
run_one() {
  ...
  (
    ...
    export AWBC_COEF="${AWBC_COEF:-0}" BC_PRETRAIN_STEPS="${BC_PRETRAIN_STEPS:-0}" BC_PRETRAIN_EPOCHS="${BC_PRETRAIN_EPOCHS:-0}" BC_PRETRAIN_LOSS_COEF="${BC_PRETRAIN_LOSS_COEF:-0}"
    export BC_PRETRAIN_TARGET_MODE="${BC_PRETRAIN_TARGET_MODE:-hard}" BC_PRETRAIN_DECISION_ONLY="${BC_PRETRAIN_DECISION_ONLY:-0}" BC_SOFT_TEMPERATURE="${BC_SOFT_TEMPERATURE:-1.0}"
    ...
    export REWARD_LOSS_NORMALIZATION="${REWARD_LOSS_NORMALIZATION:-none}" REWARD_PROXY_MODE="${REWARD_PROXY_MODE:-forecast_block_gain}"
    export FORECAST_VALUE_AUX_COEF="${FORECAST_VALUE_AUX_COEF:-0}" FORECAST_VALUE_AUX_STRIDE="${FORECAST_VALUE_AUX_STRIDE:-32}" FORECAST_VALUE_AUX_LOOKAHEAD_STEPS="${FORECAST_VALUE_AUX_LOOKAHEAD_STEPS:-6}"
    export FORECAST_VALUE_AUX_LOSS="${FORECAST_VALUE_AUX_LOSS:-mse}" FORECAST_VALUE_AUX_TEMPERATURE="${FORECAST_VALUE_AUX_TEMPERATURE:-1.0}" FORECAST_VALUE_RANKING_COEF="${FORECAST_VALUE_RANKING_COEF:-0.0}"
