...
run_one() {
  ...
  (
    ...
    export RUN_PREFIX="v267_block_gain_pdppo_sixch_dev"
    ...
    export REWARD_LOSS_NORMALIZATION=none REWARD_PROXY_MODE=forecast_block_gain
  ...
  ) >"logs/v267_block_gain_pdppo_sixch_seed${seed}.log" 2>&1
}
