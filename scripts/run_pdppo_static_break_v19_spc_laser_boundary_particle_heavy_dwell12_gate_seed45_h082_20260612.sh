...
OUT_DIR="reports/v31_static_break_v19_spc_laser_boundary_particle_heavy_dwell12_gate_seed45_h082_20260612"
mkdir -p "$OUT_DIR"

python scripts/63_v31_static_break_calibration.py \
  --sensor-cfg configs/sensors/windblown_sensors_physical_event_v19_spc_laser_boundary.yaml \
  --out-dir "$OUT_DIR" \
  --profiles particle_heavy_flux_v7 \
  --budgets 1.10 \
