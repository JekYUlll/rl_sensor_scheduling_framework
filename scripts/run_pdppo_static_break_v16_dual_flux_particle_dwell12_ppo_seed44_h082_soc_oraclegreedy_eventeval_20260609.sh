...
OUT_DIR=reports/v31_static_break_v16_dual_flux_particle_dwell12_ppo_seed44_h082_soc_oraclegreedy_eventeval_20260609
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 44 \
  --out-name v16_dual_flux_particle_b1p15_seed44_h082_soc_oraclegreedy_eventeval_summary.csv
