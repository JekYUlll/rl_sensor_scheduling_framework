...
ASSET_ROOT="${V680_ASSET_ROOT:-reports/v680_observable_target_resource_assets_b2p50_20260911}"
OUT_ROOT="${V680_OUT_ROOT:-reports/v680_observable_target_resource_geometry_b2p50_20260911}"
mkdir -p "$OUT_ROOT"
START_ARGS=(
