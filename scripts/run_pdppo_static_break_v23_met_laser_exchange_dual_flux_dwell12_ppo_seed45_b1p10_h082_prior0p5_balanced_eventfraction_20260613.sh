...
OUT_DIR=reports/v31_static_break_v23_met_laser_exchange_dual_flux_dwell12_ppo_seed45_b1p10_h082_prior0p5_balanced_eventfraction_20260613
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 45 \
  --out-name v23_metlaser_dualflux_b1p10_seed45_h082_prior0p5_balanced_eventfraction_summary.csv
