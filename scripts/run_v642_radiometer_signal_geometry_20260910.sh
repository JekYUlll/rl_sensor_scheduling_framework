...
RUN_ROOT="${V642_ASSET_ROOT:-reports/v641_radiometer_signal_assets_b2p15_20260910}"
OUT_ROOT="${V642_GEOMETRY_ROOT:-reports/v642_radiometer_signal_geometry_b2p15_20260910}"
cd "$ROOT"
mkdir -p "$OUT_ROOT"
