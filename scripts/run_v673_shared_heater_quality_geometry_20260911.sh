...
ASSET_ROOT="${V673_ASSET_ROOT:-reports/v673_shared_heater_quality_assets_b2p15_20260911}"
OUT_ROOT="${V673_OUT_ROOT:-reports/v673_shared_heater_quality_geometry_b2p15_20260911}"
mkdir -p "$OUT_ROOT"
START_ARGS=(
