...
TRUTH_ROOT="${V656_TRUTH_ROOT:-reports/v535_persistent_transport_truth_20260909}"
RESOURCE_ROOT="${V656_RESOURCE_ROOT:-reports/v535_persistent_transport_resource_20260909}"
OUT_ROOT="${V656_OUT_ROOT:-reports/v656_stageb_budget5_assets_20260910}"
...
for seed in 7231 7232 7233 7234; do
  ...
  "$PYTHON_BIN" scripts/25_v2_train_custom_ppo.py \
    ...
    --dynamic-resource-budget-w 5.0 --include-dynamic-resource-state \
