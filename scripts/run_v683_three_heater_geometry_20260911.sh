...
ASSET_ROOT="${V683_ASSET_ROOT:-reports/v683_three_heater_assets_b2p50_20260911}"
OUT_ROOT="${V683_GEOMETRY_ROOT:-reports/v683_three_heater_geometry_b2p50_20260911}"
mkdir -p "$OUT_ROOT"
START_ARGS=(
