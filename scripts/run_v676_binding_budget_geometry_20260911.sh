...
ASSET_ROOT="${V676_ASSET_ROOT:-reports/v675_split_affinity_quality_assets_b2p15_20260911}"
OUT_ROOT="${V676_OUT_ROOT:-reports/v676_binding_budget_geometry_b1p45_20260911}"
mkdir -p "$OUT_ROOT"
START_ARGS=(
...
for seed in 7177 7178 7179 7180; do
  "$PYTHON_BIN" scripts/109_v32_audit_subset_forecast_geometry.py \
    ...
    --steady-budget 1.45 --startup-budget 1.45 \
    --dynamic-resource-budget 1.45 \
