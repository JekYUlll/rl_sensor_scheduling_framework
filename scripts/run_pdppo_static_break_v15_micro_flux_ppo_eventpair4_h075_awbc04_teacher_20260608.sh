...
OUT_DIR=reports/v31_static_break_v15_micro_flux_ppo_eventpair4_h075_awbc04_teacher_20260608
...
"$PY" scripts/65_v31_collect_operational_pdppo.py \
  ...
  --seeds 41 \
  --out-name v15_micro_flux_b1p15_seed41_eventpair4_h075_awbc04_teacher_summary.csv
