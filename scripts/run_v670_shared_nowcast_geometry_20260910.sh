...
ASSET_ROOT="${V670_ASSET_ROOT:-reports/v669_shared_nowcast_assets_b2p15_20260910}"
OUT_ROOT="${V670_OUT_ROOT:-reports/v670_shared_nowcast_geometry_b2p15_20260910}"
mkdir -p "$OUT_ROOT"
START_ARGS=(
