...
OUT_DIR="${OUT_DIR:-reports/v31_static_break_v24_event_selective_laser_particle_heavy_dwell12_ppo_seed45_b1p10_h082_cyclicteacher_awbc0p8_eventfraction_20260620}"
SUMMARY_NAME="${SUMMARY_NAME:-v24_eventlaser_particleheavy_cyclicteacher_awbc0p8_seed45_h082_eventfraction_summary.csv}"
...
# From the Phase-14 split replay gate winner:
# split_top2_l6_dwell12, loss 0.414078 vs same-run AoI reference 0.429470.
CALM_TOP2="radiometer_basic,shielded_thermo_hygro,snow_particle_counter;radiometer_basic,surface_temp_ir,shielded_thermo_hygro,laser_disdrometer"
