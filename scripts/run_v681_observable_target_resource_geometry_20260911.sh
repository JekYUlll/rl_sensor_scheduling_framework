...
ASSET_ROOT="${V681_ASSET_ROOT:-reports/v681_observable_target_resource_assets_b2p50_20260911}"
OUT_ROOT="${V681_GEOMETRY_ROOT:-reports/v681_observable_target_resource_geometry_b2p50_20260911}"
mkdir -p "$OUT_ROOT"
START_ARGS=(
