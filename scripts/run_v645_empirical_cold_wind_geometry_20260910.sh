...
RUN_ROOT="${V645_ASSET_ROOT:-reports/v645_empirical_cold_wind_assets_b2p15_20260910}"
OUT_ROOT="${V645_GEOMETRY_ROOT:-reports/v645_empirical_cold_wind_geometry_b2p15_20260910}"
mkdir -p "$OUT_ROOT"
...
for seed in 7401 7402 7403 7404; do
  ...
  "$PYTHON_BIN" scripts/109_v32_audit_subset_forecast_geometry.py \
    ...
    --steady-budget 2.15 --startup-budget 2.60 --dynamic-resource-budget 55.0 \
