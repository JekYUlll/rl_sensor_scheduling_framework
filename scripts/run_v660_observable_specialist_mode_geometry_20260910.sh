...
RUN_ROOT="${V660_RUN_ROOT:-reports/v659_observable_specialist_mode_assets_20260910}"
OUT_ROOT="${V660_OUT_ROOT:-reports/v660_observable_specialist_mode_geometry_20260910}"
mkdir -p "$OUT_ROOT"
