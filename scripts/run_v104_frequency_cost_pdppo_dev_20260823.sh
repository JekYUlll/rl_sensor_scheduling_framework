...
PY
    ...
    export ORACLE_SUBTYPE_TEACHER_REPEAT=6
    export ORACLE_INFERENCE_DEVICE="${ORACLE_INFERENCE_DEVICE_OVERRIDE:-cpu}"
    ...
    export FORECAST_VALUE_AUX_COEF="${FORECAST_VALUE_AUX_COEF_OVERRIDE:-0.0}"
    export FORECAST_VALUE_AUX_STRIDE="${FORECAST_VALUE_AUX_STRIDE_OVERRIDE:-64}"
    export FORECAST_VALUE_AUX_LOOKAHEAD_STEPS="${FORECAST_VALUE_AUX_LOOKAHEAD_STEPS_OVERRIDE:-0}"
    export FORECAST_VALUE_AUX_LOSS="${FORECAST_VALUE_AUX_LOSS_OVERRIDE:-mse}"
    export FORECAST_VALUE_AUX_TEMPERATURE="${FORECAST_VALUE_AUX_TEMPERATURE_OVERRIDE:-1.0}"
    ...
    export CONTEXT_FEATURE_DIM=20 CONTEXT_FUSION_MODE="${CONTEXT_FUSION_MODE_OVERRIDE:-gated_add}"
    ...
    export CHECKPOINT_SELECTION_SCORE="${CHECKPOINT_SELECTION_SCORE_OVERRIDE:-oracle_loss_mean}"
