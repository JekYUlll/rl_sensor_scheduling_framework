# V282 corrected decision-only ordinary-forecast PD-PPO development

V282 reruns the decision-only ordinary-forecast policy-credit control after correcting the decision-row collector, using the matched V280/V279 scene and validation assets.
